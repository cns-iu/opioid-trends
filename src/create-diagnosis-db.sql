...
-- Opioid Use
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Opioid Use' AS "DATA_VARIABLE",
      N_OPIOID_DIAGNOSED_CHRONIC AS "VALUE",
  ...
  UNION ALL
    SELECT
      ...
      'Opioid Use' AS "DATA_VARIABLE",
      N_OPIOID_DIAGNOSED_NONCHRONIC AS "VALUE",
...
-- Opioid Poisoning
  UNION ALL
    SELECT
      ...
      N_OPIOID_POISONING_DIAGNOSED AS "VALUE",
      N_OPIOID_PRESCRIBERS AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Opioid Poisoning' AS "DATA_VARIABLE",
      N_OPIOID_POISONING_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'Opioid Poisoning' AS "DATA_VARIABLE",
      N_OPIOID_POISONING_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- STD
  UNION ALL
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'STD' AS "DATA_VARIABLE",
      N_STD_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'STD' AS "DATA_VARIABLE",
      N_STD_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- HIV
  UNION ALL
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'HIV' AS "DATA_VARIABLE",
      N_HIV_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'HIV' AS "DATA_VARIABLE",
      N_HIV_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- Mental health disorder
  UNION ALL
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Mental Health' AS "DATA_VARIABLE",
      N_MENTAL_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'Mental Health' AS "DATA_VARIABLE",
      N_MENTAL_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- Substance abuse disorder
  UNION ALL
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Substance Abuse Disorder' AS "DATA_VARIABLE",
      N_SUD_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'Substance Abuse Disorder' AS "DATA_VARIABLE",
      N_SUD_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- Alcohol poisoning
  UNION ALL
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Alcohol Poisoning' AS "DATA_VARIABLE",
      N_ALCOHOL_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'Alcohol Poisoning' AS "DATA_VARIABLE",
      N_ALCOHOL_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- Benzo poisoning
  UNION ALL
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Benzo Poisoning' AS "DATA_VARIABLE",
      N_BENZO_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'Benzo Poisoning' AS "DATA_VARIABLE",
      N_BENZO_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- Drug poisoning
  UNION ALL
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Drug Poisoning' AS "DATA_VARIABLE",
      N_DRUG_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'Drug Poisoning' AS "DATA_VARIABLE",
      N_DRUG_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- Other poisoning
  UNION ALL
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Other Poisoning' AS "DATA_VARIABLE",
      N_OTHER_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'Other Poisoning' AS "DATA_VARIABLE",
      N_OTHER_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- Overdose
  UNION ALL
  ...
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Overdose' AS "DATA_VARIABLE",
      N_OVERDOSE_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'Overdose' AS "DATA_VARIABLE",
      N_OVERDOSE_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
-- Stimulant poisoning
  UNION ALL
    SELECT
      ...
      N_STIMULANT_DIAGNOSED AS "VALUE",
      N_OPIOID_PRESCRIBERS AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Chronic' as "COHORT",
      'Stimulant Poisoning' AS "DATA_VARIABLE",
      N_STIMULANT_DIAGNOSED_CHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_CHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      ...
      'Non-chronic' as "COHORT",
      'Stimulant Poisoning' AS "DATA_VARIABLE",
      N_STIMULANT_DIAGNOSED_NONCHRONIC AS "VALUE",
      N_OPIOID_PRESCRIBERS_NONCHRONIC AS "TOTAL"
    FROM ALL_AGGREGATES
  ) AS A
