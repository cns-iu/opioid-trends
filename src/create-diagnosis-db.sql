...
CREATE TABLE "DIAGNOSES_AGG_STD_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'STD_DX' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_STD_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'STD_DX' AND IS_CHRONIC == 0
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_HIV_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'HIV_DX' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_HIV_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'HIV_DX' AND IS_CHRONIC == 0
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_MENTAL_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'ENCOUNTER_MENTAL_DX' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_MENTAL_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'ENCOUNTER_MENTAL_DX' AND IS_CHRONIC == 0
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_SUD_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'SUBSTANCE_USE_DISORDER' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_SUD_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'SUBSTANCE_USE_DISORDER' AND IS_CHRONIC == 0
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_ALCOHOL_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'ALCOHOL_POISONING_DX' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_ALCOHOL_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'ALCOHOL_POISONING_DX' AND IS_CHRONIC == 0
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_BENZO_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'BENZO_POISONING_DX' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_BENZO_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'BENZO_POISONING_DX' AND IS_CHRONIC == 0
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_DRUG_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'ILLICIT_DRUG_POISONING_DX' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_DRUG_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'ILLICIT_DRUG_POISONING_DX' AND IS_CHRONIC == 0
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_OTHER_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'OTHER_POISONING_DX' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_OTHER_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'OTHER_POISONING_DX' AND IS_CHRONIC == 0
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_OVERDOSE_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'OVERDOSE' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_OVERDOSE_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'OVERDOSE' AND IS_CHRONIC == 0
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_STIMULANT_CHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'STIMULANT_POISONING_DX' AND IS_CHRONIC == 1
  GROUP BY period;
...
CREATE TABLE "DIAGNOSES_AGG_STIMULANT_NONCHRONIC" AS
  ...
  FROM DIAGNOSES_AND_CHRONIC
  WHERE DX_CODE_TYPE == 'STIMULANT_POISONING_DX' AND IS_CHRONIC == 0
  GROUP BY period;
...
-- Opioid Use
    SELECT
      ...
      sum(N_OPIOID_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Opioid Use' AS "DATA_VARIABLE",
      sum(N_OPIOID_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      ...
      'Opioid Use' AS "DATA_VARIABLE",
      sum(N_OPIOID_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- Opioid Poisoning
  UNION ALL
    SELECT
      ...
      sum(N_OPIOID_POISONING_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Opioid Poisoning' AS "DATA_VARIABLE",
      sum(N_OPIOID_POISONING_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'Opioid Poisoning' AS "DATA_VARIABLE",
      sum(N_OPIOID_POISONING_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- STD
  UNION ALL
    SELECT
      ...
      sum(N_STD_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'STD' AS "DATA_VARIABLE",
      sum(N_STD_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'STD' AS "DATA_VARIABLE",
      sum(N_STD_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- HIV
  UNION ALL
    SELECT
      ...
      sum(N_HIV_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'HIV' AS "DATA_VARIABLE",
      sum(N_HIV_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'HIV' AS "DATA_VARIABLE",
      sum(N_HIV_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- Mental health disorder
  UNION ALL
    SELECT
      ...
      sum(N_MENTAL_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Mental Health' AS "DATA_VARIABLE",
      sum(N_MENTAL_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'Mental Health' AS "DATA_VARIABLE",
      sum(N_MENTAL_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- Substance abuse disorder
  UNION ALL
    SELECT
      ...
      sum(N_SUD_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Substance Abuse Disorder' AS "DATA_VARIABLE",
      sum(N_SUD_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'Substance Abuse Disorder' AS "DATA_VARIABLE",
      sum(N_SUD_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- Alcohol poisoning
  UNION ALL
    SELECT
      ...
      sum(N_ALCOHOL_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Alcohol Poisoning' AS "DATA_VARIABLE",
      sum(N_ALCOHOL_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'Alcohol Poisoning' AS "DATA_VARIABLE",
      sum(N_ALCOHOL_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- Benzo poisoning
  UNION ALL
    SELECT
      ...
      sum(N_BENZO_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Benzo Poisoning' AS "DATA_VARIABLE",
      sum(N_BENZO_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'Benzo Poisoning' AS "DATA_VARIABLE",
      sum(N_BENZO_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- Drug poisoning
  UNION ALL
    SELECT
      ...
      sum(N_DRUG_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Drug Poisoning' AS "DATA_VARIABLE",
      sum(N_DRUG_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'Drug Poisoning' AS "DATA_VARIABLE",
      sum(N_DRUG_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- Other poisoning
  UNION ALL
    SELECT
      ...
      sum(N_OTHER_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Other Poisoning' AS "DATA_VARIABLE",
      sum(N_OTHER_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'Other Poisoning' AS "DATA_VARIABLE",
      sum(N_OTHER_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- Overdose
  UNION ALL
    SELECT
      ...
      sum(N_OVERDOSE_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Overdose' AS "DATA_VARIABLE",
      sum(N_OVERDOSE_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'Overdose' AS "DATA_VARIABLE",
      sum(N_OVERDOSE_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
-- Stimulant poisoning
  UNION ALL
    SELECT
      ...
      sum(N_STIMULANT_DIAGNOSED) / (avg(N_OPIOID_PRESCRIBERS)*count(N_OPIOID_PRESCRIBERS)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Chronic' as "COHORT",
      'Stimulant Poisoning' AS "DATA_VARIABLE",
      sum(N_STIMULANT_DIAGNOSED_CHRONIC) / (avg(N_OPIOID_PRESCRIBERS_CHRONIC)*count(N_OPIOID_PRESCRIBERS_CHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  UNION ALL
    SELECT
      PERIOD,
      'Non-chronic' as "COHORT",
      'Stimulant Poisoning' AS "DATA_VARIABLE",
      sum(N_STIMULANT_DIAGNOSED_NONCHRONIC) / (avg(N_OPIOID_PRESCRIBERS_NONCHRONIC)*count(N_OPIOID_PRESCRIBERS_NONCHRONIC)) AS "VALUE"
    FROM ALL_AGGREGATES
  ) AS A
  WHERE cast(strftime('%Y', PERIOD) as integer) <= 2018 AND cast(strftime('%Y', PERIOD) as integer) >= 2009
  GROUP BY COHORT, data_variable
