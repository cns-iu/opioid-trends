...
CREATE TABLE ALL_AGGREGATES_ROW_BASED AS
  ...
  UNION ALL
    SELECT
      ...
      AGE_GROUP_NAME AS DATA_VARIABLE,
      100 * cast(N_AGE_NON_CHRONIC AS real) / N_PERSONS_NON_CHRONIC AS VALUE,
      CASE
  ...
  UNION ALL
    SELECT
      ...
      'Non-chronic' AS COHORT,
      GENDER AS DATA_VARIABLE,
      100 * cast(N_GENDER_NON_CHRONIC AS real) / N_PERSONS_NON_CHRONIC AS VALUE,
      CASE
  ...
  UNION ALL
    SELECT
      ...
      'Non-chronic' AS COHORT,
      RACE AS DATA_VARIABLE,
      100 * cast(N_RACE_NON_CHRONIC AS real) / N_PERSONS_NON_CHRONIC AS VALUE,
      CASE
